...
1. ros2 launch demo_python_action demo.launch.py 从launch文件启动多个节点
2. ros2 launch demo_python_action demo.launch.py launch_max_speed:=3.0 指定参数值启动节点
"""
...
def generate_launch_description():
    ...
    # 启动动作服务端节点
    action_node_action_server = Node(
        package="demo_python_action",  # 功能包名
        executable="action_server",  # 可执行文件名
    ...
    # 启动动作客户端节点
    action_node_action_client = Node(
        package="demo_python_action",
    ...
    launch_description = LaunchDescription(
        [
            ...
            action_node_action_server,
            action_node_action_client,
